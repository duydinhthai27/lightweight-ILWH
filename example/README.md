...
```
 python main2.py --gpu 3 --strategy DRW --config config/config_cinic10.yaml
```
...
* Train from scratch
```
    python main2.py --gpu 1 --strategy ERM --c config/config_cinic10.yaml --sampling WeightedRandomBatchSampler
```
